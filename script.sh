...
echo "Zihao"   # fill in your name here
echo "Abdul"
...
# Let's separate again and print how many genres each movie belongs to.
awk -F '::' '{print $3}' movies.dat | awk '{print split($0, a, "\\|")}'

# 3. finish the pipeline by adding 2 commands that will produce a contingency table
awk -F '::' '{print $3}' movies.dat | awk '{print split($0, a, "\\|")}' | sort | uniq -c > outtable.txt

# 4. print your table to screen
cat outtable.txt
